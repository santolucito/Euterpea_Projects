...
> midiInLoop stopVar msgChan devsVar = do
>     quit <- undefined -- read from stopVar
>     devsOn <- undefined -- read from devsVar
>     let f dev = undefined -- check validity then pollMidi
>         msgs = map f devsOn
>     if quit then return () else midiInLoop stopVar msgChan devsVar

> midiOutOp :: TVar Double -> IO ()
