...
We will need to setup the system and get the device id we want to play on. getD is jsut going to grab the first midi device it sees, you might want to adjust this depending on your system.
...
Notice that there is no syncronization. We are working on it...
